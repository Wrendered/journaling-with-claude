---
name: onboarding
description: Set up or resume a personal journaling vault, preserving any existing history and preferences.
---
...
1. Inspect existing private/ and current context before creating anything. Returning users do not need to repeat onboarding.
2. Create only missing directories: journal/entries, raw/imports, state, views, relationships, decisions, goals, career, writing, projects, reviews, history. Copy missing relevant templates with the .template portion removed. Never overwrite existing pages.
